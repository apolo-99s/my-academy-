// ============================================================
// DATA.JS - 10 SKILLS AVEC 4 NIVEAUX CHACUN + BG IMAGES
// ============================================================
...
// ============================================================
// SKILLS (10 SKILLS AVEC 4 NIVEAUX CHACUN)
// ============================================================
var SKILLS = [
  // ===== SKILL 1: GRAPHIC DESIGN (avec tous les niveaux) =====
  {
    id: 'design',
    icon: '🎨',
    color: '#7C3AED',
        ...
        lessons: [
          {
            ...
            layout: 'top',
            steps: {
              fr: ['Page Color: graphe de noeuds','3 oscilloscopes: Waveform, Parade, Vectorscope','Roues primaires: Lift (ombres), Gamma (tons moyens), Gain (hautes lumières)','Outil Qualificateur: isole UNE couleur','Correspondance plans: Capturer image fixe → Appliquer grade','LUTs: appliquez à 30-70% opacité'],
              ar: ['صفحة Color: رسم العقد','3 أجهزة قياس: Waveform, Parade, Vectorscope','العجلات الأساسية: Lift (ظلال), Gamma (أوساط), Gain (إضاءات)','أداة المؤهّل: يعزل لون واحد','مطابقة اللقطات: التقاط صورة ثابتة → تطبيق الgrade','LUTs: طبّق بشفافية 30-70%'],
              en: ['Color page: node graph','3 scopes: Waveform, Parade, Vectorscope','Primary wheels: Lift (shadows), Gamma (midtones), Gain (highlights)','Qualifier tool: isolates ONE color','Shot matching: Grab Still → Apply Grade','LUTs: apply at 30-70% opacity']
            },
        ...
        lessons: [
          {
            ...
            layout: 'top',
            steps: {
              fr: ['Architecture: Frontend (React) → Backend (Node.js) → DB (MongoDB)','Git: git init, add, commit, push','Agile/Scrum pour gérer les sprints','Déploiement: Vercel, Netlify, Heroku','Sécurité: HTTPS, JWT','Tarification: site vitrine 50-200K, e-commerce 200K-1M DZD'],
              ar: ['الهندسة: Frontend (React) → Backend (Node.js) → DB (MongoDB)','Git: git init, add, commit, push','Agile/Scrum لإدارة الـ sprints','النشر: Vercel, Netlify, Heroku','الأمان: HTTPS, JWT','التسعير: موقع عرضي 50-200K، تجاري 200K-1M دج'],
              en: ['Architecture: Frontend (React) → Backend (Node.js) → DB (MongoDB)','Git: git init, add, commit, push','Agile/Scrum to manage sprints','Deployment: Vercel, Netlify, Heroku','Security: HTTPS, JWT','Pricing: portfolio 50-200K, e-commerce 200K-1M DZD']
            },
        ...
        lessons: [
          {
            ...
            layout: 'top',
            steps: {
              fr: ['Title: 50-60 caractères avec mot-clé','Meta: 150-160 caractères avec CTA','H1-H6: un seul H1 par page','URL: courte, descriptive','Contenu: 800+ mots','Liens internes'],
              ar: ['Title: 50-60 حرف مع كلمة مفتاحية','Meta: 150-160 حرف مع CTA','H1-H6: H1 واحد فقط لكل صفحة','الرابط: قصير، وصفي','المحتوى: 800+ كلمة','روابط داخلية'],
              en: ['Title: 50-60 characters with keyword','Meta: 150-160 characters with CTA','H1-H6: one H1 per page','URL: short, descriptive','Content: 800+ words','Internal links']
            },
  ...
  // ===== SKILL 8: UI/UX DESIGN =====
  {
    ...
    levels: [
      ...
      },
      {
        ...
        goal: { fr: 'Maîtriser Figma et les composants', ar: 'إتقان Figma والمكونات', en: 'Master Figma and components' },
        lessons: [
          {
            id: 'uiux-i-1',
            ...
            layout: 'top',
            steps: {
              fr: ['Figma = outil de design collaboratif','Interface: Canvas, panneaux','Outils: Rectangle, Texte, Ellipse','Frames: conteneurs','Layers: organisation','Prototypage: interactif'],
              ar: ['Figma = أداة تصميم تعاونية','الواجهة: لوحة، لوحات جانبية','الأدوات: مستطيل، نص، قطع ناقص','الإطارات: حاويات','الطبقات: تنظيم','النماذج الأولية: تفاعلية'],
              en: ['Figma = collaborative design tool','Interface: Canvas, panels','Tools: Rectangle, Text, Ellipse','Frames: containers','Layers: organization','Prototyping: interactive']
            },
            method: { fr: 'Créez un projet Figma pour un portfolio.', ar: 'أنشئ مشروع Figma لبورتفوليو.', en: 'Create a Figma project for a portfolio.' },
            exercise: { fr: 'Refaites un site web populaire dans Figma.', ar: 'أعد إنشاء موقع ويب شهير في Figma.', en: 'Redesign a popular website in Figma.' },
            tip: { fr: '💡 Raccourcis: R (rectangle), T (texte), F (frame).', ar: '💡 اختصارات: R (مستطيل)، T (نص)، F (إطار).', en: '💡 Shortcuts: R (rectangle), T (text), F (frame).' }
          }
        ]
      },
      {
        ...
        lessons: [
          {
            ...
            layout: 'top',
            steps: {
              fr: ['UX Research = comprendre les besoins','Méthodes: interviews, sondages','Interview: 5-8 utilisateurs','Objectif: décisions basées sur des données'],
              ar: ['بحث UX = فهم الاحتياجات','الطرق: مقابلات، استبيانات','المقابلة: 5-8 مستخدمين','الهدف: قرارات مبنية على بيانات'],
              en: ['UX Research = understanding needs','Methods: interviews, surveys','Interview: 5-8 users','Goal: data-driven decisions']
            },
            method: { fr: 'Menez 5 interviews utilisateurs.', ar: 'أجرِ 5 مقابلات مع مستخدمين.', en: 'Conduct 5 user interviews.' },
            exercise: { fr: 'Créez un plan de recherche UX complet.', ar: 'أنشئ خطة بحث UX كاملة.', en: 'Create a complete UX research plan.' },
        ...
        lessons: [
          {
            ...
            layout: 'top',
            steps: {
              fr: ['Handoff = livraison du design','Figma: Inspect mode','Exporter: assets (PNG, SVG)','Design Tokens','Style Guide'],
              ar: ['التسليم للمطورين = تسليم التصميم','Figma: وضع التدقيق','التصدير: أصول (PNG، SVG)','رموز التصميم','دليل الأنماط'],
              en: ['Handoff = design delivery','Figma: Inspect mode','Export: assets (PNG, SVG)','Design Tokens','Style Guide']
            },
            method: { fr: 'Préparez un package de handoff complet.', ar: 'جهز حزمة تسليم كاملة.', en: 'Prepare a complete handoff package.' },
            exercise: { fr: 'Créez un handoff complet avec documentation.', ar: 'أنشئ تسليماً كاملاً مع توثيق.', en: 'Create a complete handoff with documentation.' },
            tip: { fr: '💡 Un bon handoff = design bien implémenté.', ar: '💡 تسليم جيد = تصميم منفذ جيداً.', en: '💡 A good handoff = well-implemented design.' }
          }
        ]
      }
    ]
